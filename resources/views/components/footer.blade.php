<footer class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  <!-- Grid -->
  <div class="lg:flex justify-evenly gap-6 mb-10">
    <div class="col-span-full max-w-[300px] hidden lg:col-span-1 lg:block">
      <a class="flex-none text-xl font-semibold dark:text-white" href="#" aria-label="Brand">Kedai ES-EM</a>
      <p class="mt-3 text-xs sm:text-sm text-gray-600 dark:text-gray-400">adalah kedai makanan yang bertempat di daerah indramayu khususnya daerah kertasemaya. Situs web ini menampilkan rincian seperti menu kedai, jam operasional, lokasi, informasi kontak, dan opsi reservasi online.</p>
    </div>
    <!-- End Col -->

    <div>
      <h4 class="text-xs font-semibold text-gray-900 uppercase dark:text-gray-100">Quick links</h4>

      <div class="mt-3 grid space-y-3 text-sm">
        <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="#">Layanan</a></p>
        <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="#">Menu</a></p>
        <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="#">Tentang</a></p>
        <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="#">Kontak</a></p>
      </div>
    </div>
    <!-- End Col -->
    ...
    <div>
      <h4 class="text-xs font-semibold text-gray-900 uppercase dark:text-gray-100">Contact Us</h4>
      <span>
...
<div class="mt-3 grid space-y-3 text-sm">
        ...
        <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="#">
...
</svg>kedaiesem@gmail.com</a></p>
        <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="#">Kertasemaya</a> <span class="inline text-blue-600 dark:text-blue-500">— New</span></p>
      </div>
